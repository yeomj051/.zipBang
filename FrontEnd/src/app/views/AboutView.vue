        ...
        <b-container>
            ...
            <b-row class="about__section">
                <b-col cols="12" md="12" lg="6" class="about-info__container">
                    <div data-aos="fade-right" data-aos-duration="1000" class="text-left px-2">
                        ...
                        <p>
                            Bitcoffee team is composed by Angel, Carlos, Jonathan, we are passionate
                            about the projects that like to learn new things, as well as being part
                            of the discoveries of these new technologies.
                            <br />
                            <br />
                            We have been working together for almost four years so we are used to
                            work together in our multiple projects.
                        </p>
                    </div>
                </b-col>
                <b-col
                ...
                >
                    <div>
                        <img class="w-100" src="../assets/images/cfee-open.png" alt="coffee-open" />
                    </div>
                </b-col>
            </b-row>
            ...
            <b-container class="token-address__container text-center">
                <div class="w-100" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="100">
                    <h1><strong>Buy us a coffee</strong></h1>
                    <p class="my-5">
                        If you'd like to donate to the Devs, send rDAI, rBTC, BITC here. Thank you
                        for your support!
                    </p>
                    <b-button
